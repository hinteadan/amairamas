    ...
    grunt.initConfig({
        ...
        jshint: {
            ...
            all: [
              'Gruntfile.js',
              '<%= yeoman.app %>/js/{,*/}*.js',
              '!<%= yeoman.app %>/js/external/*.js',
              '!<%= yeoman.app %>/js/quant.js',
              '!<%= yeoman.app %>/js/data/activities.js',
              '!<%= yeoman.app %>/js/data/places.js',
              '!<%= yeoman.app %>/js/data/categories.js'
            ]
        },
        ...
        concat: {
            ngtemplate: {
                src: ['.tmp/concat/app.js', '.tmp/templates.js'],
